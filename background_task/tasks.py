...
class Tasks(object):
    ...
    def background(self, name=None, schedule=None, queue=None,
                   remove_existing_tasks=False, just_once=False):
        '''
        ...
        def _decorator(fn):
            ...
            proxy = self._task_proxy_class(_name, fn, schedule, queue,
                                           remove_existing_tasks, just_once, self._runner)
...
class DBTaskRunner(object):
    ...
    def schedule(self, task_name, args, kwargs, run_at=None,
                 ...
                 repeat=None, repeat_until=None, remove_existing_tasks=False, just_once=False):
...
class TaskProxy(object):
    def __init__(self, name, task_function, schedule, queue, remove_existing_tasks, just_once, runner):
        self.name = name
